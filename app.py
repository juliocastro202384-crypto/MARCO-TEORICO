...
OPENALEX:
  ...
  fields: [id, doi, title, publication_year, authorships, primary_location,
           open_access, abstract_inverted_index, primary_topic, host_venue]
REDALYC:
  query_1: "..."
  query_2: "..."
LATINDEX:
...
Extrae: Titulo, Problema, Objetivo general, Objetivos especificos, Preguntas,
Ruta, Contexto, Poblacion, Variables/Categorias, Producto.
...
with col2:
    st.markdown(
        ...
        'Citas clasificadas como semillas para busqueda, no como evidencia.</div>',
        unsafe_allow_html=True
    )
with col3:
    st.markdown(
...
3. Si el gate falla -> MODO A: exactamente 5 secciones.
