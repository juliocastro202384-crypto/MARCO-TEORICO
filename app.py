# app.py -- Constructor de Marco Teorico v5.9.0
...
SYSTEM_PROMPT = (
    "AGENTE: CONSTRUCTOR DE MARCO TEORICO v5.9\n"
...
with st.sidebar:
    ...
    st.markdown("**v5.9.0 - Claude - OpenAlex + S2 + Crossref**")
    st.markdown("---")
...
st.markdown("---")
st.markdown(
    f'''<footer>Powered by Claude v5.9.0 | OpenAlex + S2 + Crossref | Rango: {RANGO} | Gate activo</footer>''',
    unsafe_allow_html=True,
)
